...
`;
  ...
  return function initMagicRings(mount, options = {}) {
    ...
    try {
      ...
      console.error('WebGL missing', e);
      return null;
    }

    if (!renderer.capabilities.isWebGL2) {
      console.warn('WebGL2 not detected, attempting fallback...');
      // Removed the early return to allow WebGL1 fallback since shaders are relatively standard
    }
